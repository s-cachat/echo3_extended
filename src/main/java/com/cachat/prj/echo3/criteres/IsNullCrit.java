 ...
 * @author scachat
 */
public class IsNullCrit extends BooleanCrit {
     ...
     */
    public IsNullCrit(CritContainer cont, String prop) {
        super(cont, prop);
    }
     ...
     */
    public IsNullCrit(CritContainer cont, String prop, Boolean def) {
        super(cont, prop, def);
    }
     ...
     * @param def le choix par defaut (true, false ou null)
     */
    public IsNullCrit(CritContainer cont, String prop, String propKey, Boolean def) {
